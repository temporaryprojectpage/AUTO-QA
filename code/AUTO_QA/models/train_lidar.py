...
from lidar_models.mlb_lidar import MUTAN_LIDAR,MLB_LIDAR
...
parser.add_argument('--model_type', default='LSTM_BASIC', choices=['MCB_LIDAR','MFB_LIDAR','SAN_LIDAR','MLB_LIDAR','MUTAN_LIDAR'],
