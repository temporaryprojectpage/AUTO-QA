...
class MFB_LIDAR(nn.Module):
    def __init__(self, args, ques_feat_size, image_feature_size, lidar_feature_size,num_classes, qa=None, encoder='lstm',grouping='single_scale'):
        ...
        self.classifier = AnswerModule(500+ques_feat_size+1024, num_classes,(256,),use_batchnorm=True,dropout=0.5)  #3500 if method is concat else 500
    ...
    def forward(self, x, feat, xlen,point_set):
        ...
        joint_feat2=torch.cat([lidar,h0],dim=1)
